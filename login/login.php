			...
			<div class="main-login-form">
				<div class="login-group">
					...
					<div class="form-group login-group-text">
                        ...
                        <a class="link" href="#" data-toggle="modal" data-target="#consentModal">Register</a>
                        or log in as
     ...
     <!-- Modal content-->
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <button onclick="agreeToTerms()" class="btn btn-success" data-dismiss="modal">Agree To Terms</a>
             </div>
         </div>
     </div>
 </div>
