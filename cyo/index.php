...
echo nl2br(htmlentities(chop($settings['main_page_text'])));
echo "</h4></div><div class=\"panel-body\">";
//print nl2br(htmlentities(chop($settings['main_page_text']))); // This prints: "This is a Riskory"
?>
<!--<br /><br /> -->
...
<script type="text/javascript">
 ...
 function modalClick() {
     ...
     // should redirect to: cyo/room.php?story=new
 }
 </script>
