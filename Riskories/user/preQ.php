        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                ...
                <form method="post" id="reg-form" action="">
                    ...
                    <div class="form-group">
                      <label for="preQ2">Question 2: How important are the little daily decisions in determining your risks?</label>
                     <ul>
                    ...
                    <div class="form-group">
                      <label for="preQ3">Question 3: How influenced are you by stories?</label>
                     <ul>
